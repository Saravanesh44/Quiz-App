...
import { getFirestore, collection, getDocs,doc ,deleteDoc } from "https://www.gstatic.com/firebasejs/11.0.2/firebase-firestore.js";
...
async function getQuiz() {
  ...
  quizData.forEach((questionData, index) => {
    ...
    document.getElementById(`Delete-${index}`).onclick = async function() {
      const QnDoc = doc(db,'Questions',questionData.id);
      await deleteDoc(QnDoc)
